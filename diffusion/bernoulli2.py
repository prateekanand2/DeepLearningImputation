    ...
    for epoch in range(epochs):
        ...
        if val_loader:
            ...
            if val_loss < best_val_loss:
                ...
                best_epoch = epoch + 1
                patience_counter = 0
                torch.save(model.state_dict(), "checkpoints/best_model_bern2.pt")
            else:
                patience_counter += 1
...
if __name__ == "__main__":
    ...
    LOG_PATH = "logs/train_bern2.log"
    OUTPUT_RESULTS = "results/diff_results_bern2.csv"

    # --- Model checkpoints ---
    FINAL_MODEL_PATH = "checkpoints/best_model_bern2.pt"
